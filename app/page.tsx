          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{marginBottom: '16px', textAlign: 'center', padding: '12px', background: '#dbeafe', borderRadius: '8px'}}>
                  <div style={{color: '#1e3a8a', fontSize: '14px', fontWeight: '600', marginBottom: '4px'}}>{t.formula}</div>
